...
## Long Site
I’m looking for more ways to apply the idea of [Long Now](https://en.wikipedia.org/wiki/Long_Now_Foundation). If you worked on something for the next 60 years, what sort of writing could you create? What could you do if you started now?
...
This is reflected [later on in the development of this website](#about-this-website-development).
...
One such approach is the [monograph](https://en.wikipedia.org/wiki/Monograph), but Long Content is any content that gets better over time.
...
* [Github](https://github.com/LukasMurdock) since 2012
