...
1. Define named polyline corridors with widths, surfaces, and optional markings. Crossings compile into shared junction surfaces and suppress markings through the intersection.
2. Place narrowly scoped freight, service, civic, shopping, construction, container, settlement, or reversal stamps with translation and rotation.
