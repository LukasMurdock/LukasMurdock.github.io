...
https://web.askhole.io/

<section class="askhole-random" data-askhole-random aria-labelledby="askhole-random-heading">
  <h2 id="askhole-random-heading">Random question</h2>
  <p id="askhole-random-question" class="askhole-random__question" data-askhole-question aria-live="polite" aria-atomic="true">
    Press Random for a question.
  </p>
  <div class="askhole-random__controls">
    <button type="button" data-askhole-button aria-controls="askhole-random-question">Random</button>
    <span class="askhole-random__remaining" data-askhole-remaining></span>
  </div>
</section>
...
<style>
  ...
  .askhole-random__question {
    font-size: var(--font-medium-large);
    min-height: 3em;
  }

  .askhole-random__controls {
    align-items: center;
    display: flex;
    flex-wrap: wrap;
    gap: 0.75rem;
  ...
  .askhole-random button:hover {
    filter: brightness(0.9);
  }

  .askhole-random button:focus-visible {
    outline: 3px solid var(--color-accent-blue);
    outline-offset: 3px;
  }

  .askhole-random button:disabled {
    cursor: not-allowed;
    opacity: 0.6;
  }

  .askhole-random__remaining {
    color: #666;
    font-size: var(--font-small);
  }
</style>

<script src="/js/askhole.js" defer></script>
