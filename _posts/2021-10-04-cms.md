...
- Stored as ASTs for easy transforms
- Easily backed-up anywhere
	- Google Drive
	- Dropbox
	- iCloud
	- Github
...
- Provide a graphical interface to optionally build custom blocks (collection types) with *fallback* types
- Provide a graphical interface to optionally build custom “page” schemas with blocks
- Provide a default website builder that uses the layout schema and Atom feeds for all collections
