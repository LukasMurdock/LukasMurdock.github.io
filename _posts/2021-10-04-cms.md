...
None provide GUIs to create custom blocks (collection types). Custom blocks mean custom data and view layer implementation.
...
But, layout building should also be *optional*—it starts with editing collections and collection items. *Document* editing.
...
Social Networks have become the primary document editors and publishers:
...
- Publication protocol: Atom feeds
- Subscription protocol: Atom feeds
