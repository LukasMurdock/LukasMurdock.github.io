...
- Be stored as ASTs for easy transforms
- Be easily backed-up anywhere
	- Google Drive
	- Dropbox
	- iCloud
	- Github
...
- [Collectible](https://ben.balter.com/2015/02/20/jekyll-collections/) by default (e.g., collection/content types: Posts, Notes, Images, Books)
...
- Provide default block types that have customizable fallbacks in text and image formats (e.g., image has text fallback “alt text”, text has [image fallback](https://carbon.now.sh/), and posts and recipes have image fallbacks—enabling Instagram posts):
	...
	- Todo/Habit → Todos/Habits (Todoist/Trello/Habitica)
...
- Provide a default website builder that uses the layout schema to build pages and provides web feeds for all collections
- Provide a plug-and-play website hosting solution
