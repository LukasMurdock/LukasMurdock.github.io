...
An attempt to keep a timeline of events I find meaningful at the time, because looking back those events are easily lost.
...
Went to [Epic Web Conf 2025](https://www.epicweb.dev/conf/2025/schedule).

Went to React Miami.

Went to THOTCON 0xD.

Met so many incredible people (thank you).

---

Now you know some stuff about me, so here’s an open invitation: [talk to me](/talk).
