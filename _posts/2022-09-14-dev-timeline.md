...
- 1957 [FORTRAN](https://fortran-lang.org/en/)
- 1959 [COBOL](https://en.wikipedia.org/wiki/COBOL)
- 1960 [Lisp](https://en.wikipedia.org/wiki/Lisp_(programming_language))
...
- 1975 [Scheme](https://www.scheme.org/) (lisp)
- 1977 [AWK](https://en.wikipedia.org/wiki/AWK)
- 1982 [PostScript](https://en.wikipedia.org/wiki/PostScript)
- 1984 [CommonLisp](https://common-lisp.net/)
- 1985 [C++](https://isocpp.org/)
- 1986 [Erlang](https://www.erlang.org/)
- 1987 [HyperTalk](https://en.wikipedia.org/wiki/HyperTalk)
- 1987 [Perl](https://www.perl.org/)
- 1989 [Bash](https://www.gnu.org/software/bash/)
- 1990 [Haskell](https://www.haskell.org/)
- 1990 [Z shell](https://www.zsh.org/)
- 1991 [HTML](https://html.spec.whatwg.org/)
- 1991 [Python](https://www.python.org/)
- 1993 [R](https://www.r-project.org/)
- 1993 [Lua](https://www.lua.org/)
- 1995 [PHP](https://www.php.net/)
- 1995 [JavaScript](https://www.ecma-international.org/publications-and-standards/standards/ecma-262/) (now ECMAScript)
- 1995 [Java](https://dev.java/)
- 1995 [Ruby](https://www.ruby-lang.org/en/)
- 1996 [CSS](https://www.w3.org/TR/CSS/#css)
- 1996 [OCaml](https://ocaml.org/)
- 1997 [Squeak](https://squeak.org/) (lisp)
- 2000 [C#](https://learn.microsoft.com/en-us/dotnet/csharp/)
- 2004 [Scala](http://www.scala-lang.org/)
- 2005 [F#](https://fsharp.org/)
- 2006 [Windows Powershell](https://learn.microsoft.com/en-us/powershell/)
- 2007 [Clojure](https://clojure.org/) (lisp)
